...
//    },
...

    {
      ...
      'expect': (res) => (res.data?.length ?? 0) >= 0
    },
...
//    },
...

    {
      ...
      'expect': (res) =>
          res.data != null && res.data[0]['_id'] == 'W_0Cuc6YbCHWYMcK15'
    },
...

    {
      ...
      'expect': (res) =>
          res.data != null && res.data[0]['_id'] == 'W_0Cuc6YbCHWYMcK05'
    },

    {
      ...
      'expect': (res) =>
          res.data != null && res.data[0]['_id'] == 'W_0Cuc6YbCHWYMcK07'
    },

    {
      ...
      'expect': (res) =>
          res.data != null && res.data[0]['_id'] == 'W_0Cuc6YbCHWYMcK14'
    },

    {
      ...
      'expect': (res) =>
          res.data != null && res.data[0]['_id'] == 'W_0Cuc6YbCHWYMcK02'
    },
    ...
    //'"MultiPoint": geo.multiPoint([geo.point(0,0)]) ID':W_0Cuc6YbCHWYMcK05
    {
      ...
      'eval': "response.data[0]['_id'] == 'W_0Cuc6YbCHWYMcK06'",
      'expect': (res) =>
          res.data != null && res.data[0]['_id'] == 'W_0Cuc6YbCHWYMcK06'
    },
    {
      'desc':
...

    {
      ...
      'eval': "response.data[0]['_id'] == 'W_0Cuc6YbCHWYMcK08'",
      'expect': (res) =>
          res.data != null && res.data[0]['_id'] == 'W_0Cuc6YbCHWYMcK08'
    },
    {
      'desc':
